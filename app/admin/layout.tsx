...
// Layout del panel de administración. El middleware ya verifica la auth.
    ...
    <div style={{ minHeight: '100dvh', backgroundColor: 'var(--rc-color-bg)' }}>
      ...
      >
        ...
        <span className="font-display text-sm" style={{ color: 'var(--rc-color-text)' }}>
          RHYTHM CONTROL{' '}
          <span style={{ color: 'var(--rc-color-accent)' }}>/ ADMIN</span>
        </span>
      ...
      {/* Contenido */}
      <div style={{ paddingTop: 'var(--rc-nav-height)' }}>
        {children}
      </div>
