// app/admin/page.tsx
// Dashboard de administración: estadísticas del inventario y control de sync.
...
export default async function AdminDashboard() {
  ...
  return (
    <div className="p-6 md:p-10 max-w-5xl mx-auto">
      ...
      <h1 className="font-display text-3xl mb-8" style={{ color: 'var(--rc-color-text)' }}>
        DASHBOARD
      </h1>
...
function StatCard({
  ...
  return (
    <div className="p-5" style={{ border: 'var(--rc-border-main)' }}>
      <p className="font-meta text-xs mb-3" style={{ color: 'var(--rc-color-muted)' }}>
        {label.toUpperCase()}
      </p>
      <p
        className="font-display text-4xl"
        style={{ color: accent ? 'var(--rc-color-accent)' : 'var(--rc-color-text)' }}
      >
        {value}
      </p>
    </div>
